    ...
    <section id="contact" className="scroll-mt-16 lg:scroll-mt-24 w-full">
      ...
      <div className="flex flex-col gap-12">
        ...
        <div className="pt-12 border-t border-border/40">
          ...
          <div className="text-text-secondary leading-relaxed max-w-xl space-y-4 mb-10">
            <p>
              I’m always open to discussing new projects, product ideas, or opportunities to build scalable digital platforms.
            </p>
            <p>
              If you’re working on something interesting, feel free to reach out.
            </p>
            <p className="text-[10px] uppercase tracking-widest font-bold text-text-secondary/50 pt-2">
          ...
          <div className="mt-4">
            <a href="mailto:contact@codebyjerry.online" className="inline-flex items-center font-bold leading-tight text-primary font-display group hover:text-accent transition-colors text-xl underline decoration-accent/30 underline-offset-8 hover:decoration-accent" aria-label="Email Contact">
              <span className="text-sm uppercase tracking-widest font-bold text-accent/80 group-hover:text-accent transition-colors mr-4">Get in touch —</span>
